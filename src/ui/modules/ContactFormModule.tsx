...
export default function ContactFormModule({
  ...
  // Define fallback reasons and use the correct variable
  ...
  const [formData, setFormData] = useState({
    ...
    email: '',
    message: '',
    reason: reasons[0] || 'contact', // Use first reason as default
    gCaptchaResponse: '',
  })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ✅ reCAPTCHA integration - update the data to be submitted
      if (showRecaptcha) {
